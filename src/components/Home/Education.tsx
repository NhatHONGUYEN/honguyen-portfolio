    ...
    <section id="education">
      <div className="container max-w-5xl mx-auto">
        <div className="border-x border-primary/10">
          <div className="flex flex-col max-w-6xl mx-auto py-10 px-4 sm:px-7">
                ...
                {educationData?.map((item, index) => (
                  ...
                  >
                    <div className="relative pl-8 sm:pl-0 sm:w-64 sm:text-right sm:pr-16">
                      ...
                      {/* Bullet Point */}
                      <div className="absolute left-1.5 sm:left-auto sm:-right-3 top-0 z-10 p-1.5 border border-primary/10 rounded-full bg-white dark:bg-background">
                        <div className="w-3 h-3 bg-primary rounded-full" />
                      </div>
                    </div>

                    <div className="flex flex-col gap-2 flex-1 sm:pl-16 ml-2 sm:ml-0">
                      <h5 className="font-semibold">{item.title[locale]}</h5>
